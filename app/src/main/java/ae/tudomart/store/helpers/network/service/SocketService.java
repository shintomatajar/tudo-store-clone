package ae.tudomart.store.helpers.network.service;

import static ae.tudomart.store.helpers.network.ApiUrl.SOCKET_BASE_URL;
...
import ae.matajar.store.BuildConfig;
...
import ae.tudomart.store.ui.activities.alert.NewOrderAlertActivity;
