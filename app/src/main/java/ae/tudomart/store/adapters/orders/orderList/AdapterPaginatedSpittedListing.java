...
public class AdapterPaginatedSpittedListing extends
        RecyclerView.Adapter<RecyclerView.ViewHolder> {

    private static final String TAG = AdapterPaginatedSpittedListing.class.getSimpleName();
    ...
    public AdapterPaginatedSpittedListing(Context context, AdapterCallback onItemClickListener) {
