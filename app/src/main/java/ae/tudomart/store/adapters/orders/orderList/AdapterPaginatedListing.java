package ae.tudomart.store.adapters.orders.orderList;
...
public class AdapterPaginatedListing extends
        RecyclerView.Adapter<RecyclerView.ViewHolder> {

    private static final String TAG = AdapterPaginatedListing.class.getSimpleName();
    ...
    public AdapterPaginatedListing(Context context, AdapterCallback onItemClickListener) {
        ...
        if (data.get(position) != null) {
            ...
            byItemsholder.mMainLayout.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    InterFragmentCommunicator comm = (InterFragmentCommunicator) context;
                    comm.onClickOrderItem(dataItem.getOrderId(), dataItem.getStatus(), dataItem.getTimeStamp());
                    callback.onClickItem(dataItem);
            ...
            if (dataItem.getDeliveryType().length() > 0) {
                ...
                } else if (data.get(position).getDeliveryType().equalsIgnoreCase("NORMAL")) {
   ...
   /* @Override
    ...
    public interface AdapterCallback {
        void onClickItem(ModelOrderList modelOrderList);
    }
