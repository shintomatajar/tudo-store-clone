package ae.tudomart.store.adapters.orders.orderDetails;
...
import ae.tudomart.store.helpers.CircularImageProgress;
import ae.tudomart.store.model.order.orderDetails.ModelOrderItems;

public class AdapterStoreOrderDetails extends RecyclerView.Adapter<AdapterStoreOrderDetails.ItemsVH> {

    ArrayList<ModelOrderItems> data;
    Context context;
    AdapterEvents callback;

    public AdapterStoreOrderDetails(ArrayList<ModelOrderItems> data, Context context, AdapterEvents callback) {
        this.data = data;
