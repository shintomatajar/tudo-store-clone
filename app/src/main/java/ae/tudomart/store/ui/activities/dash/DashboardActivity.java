package ae.tudomart.store.ui.activities.dash;
...
import ae.tudomart.store.helpers.network.service.SocketService;
import ae.tudomart.store.helpers.sharedPref.UserSessionManager;
import ae.tudomart.store.ui.activities.AllOrdersActivity;
import ae.tudomart.store.ui.activities.BaseActivity;
import ae.tudomart.store.ui.activities.NotificationsActivity;
import ae.tudomart.store.ui.activities.PrivacyPolicyActivity;
import ae.tudomart.store.ui.activities.ProfileActivity;
import ae.tudomart.store.ui.activities.auth.MainActivity;
import ae.tudomart.store.ui.activities.barcodeGenerator.BarcodeGeneratorActivity;
import ae.tudomart.store.ui.activities.settings.SettingsActivity;
import ae.tudomart.store.ui.activities.staticScreens.AboutUsActivity;
import ae.tudomart.store.ui.activities.staticScreens.HelpCentreActivity;
import ae.tudomart.store.ui.activities.staticScreens.LegalActivity;
