...
public class ReadyDispatchListActivity extends BaseActivity implements InterFragmentCommunicator {
   ...
   private LinearLayout mErrorParentLayout;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ready_dispatch_list);
        initViews();
        initToolbar();
    ...
    private void initToolbar() {
        ...
        mTitleToolbar.setText("Ready To Dispatch");
    }

   /* private void initRecycler() {
        mPackingRecycler.setAdapter(new AdapterListSplittedOrders(ReadyDispatchListActivity.this, data, new AdapterListSplittedOrders.AdapterCallback() {
            @Override
    ...
    private void addData() {
        ...
        RequestQueue rQueue = Volley.newRequestQueue(ReadyDispatchListActivity.this);
        JSONObject requestBody = new JSONObject();
        JSONArray jsonArray = Utils.getStoreJson(new UserSessionManager(this).getShopIdArray());
        ...
        try {
            ...
            requestBody.put("strLoginUserId", new UserSessionManager(ReadyDispatchListActivity.this).getUserDetails().get("userid")/*new UserSessionManager(requireActivity()).getUserId()*/);
        ...
        //Log.d("RDY DISPATCH REQ",requestBody.toString());
        //Log.d("RDY DISPATCH URL",ApiUrl.READY_DISPATCH_URL);
        JsonObjectRequest clearNotifRequest = new JsonObjectRequest(Request.Method.POST, ApiUrl.READY_DISPATCH_URL, requestBody, new Response.Listener<JSONObject>() {
            @Override
            public void onResponse(JSONObject response) {
                //Log.d("RDY DISPATCH RESP",response.toString());
                mLoadingLayout.setVisibility(View.GONE);
                try {
                    if (response.getBoolean("success")) {
                        ...
                        for (int i = 0; i < jsonArray.length(); i++) {
                            ...
                            if (order_status.equalsIgnoreCase("READY TO DISPATCH")) {
                                status = 2;
                            }
                        ...
                        mTitleToolbar.setText("Ready To Dispatch (" + itemcount + ")");
                        //initRecycler();
                        ...
                        if (response.getString("message") == " No Data Found") { // user has made no orders
                           ...
                           /* MyDialogSheet dialogSheet = new MyDialogSheet(ReadyDispatchListActivity.this);
                            dialogSheet.setTitle(getString(R.string.dialog_title_error_loading_data))
                                    ...
                                    .setBackgroundColor(ContextCompat.getColor(ReadyDispatchListActivity.this, R.color.white))
            ...
            public void onErrorResponse(VolleyError error) {
                ...
                mLoadingLayout.setVisibility(View.GONE);
                mPackingRecycler.setVisibility(View.GONE);
                Utils.checkVolleyError(ReadyDispatchListActivity.this,error);
                MyDialogSheet dialogSheet = new MyDialogSheet(ReadyDispatchListActivity.this);
                dialogSheet.setTitle(getString(R.string.dialog_title_error_loading_data))
                        .setMessage(new VolleyErrorHandler(ReadyDispatchListActivity.this).getVolleyError(error))
                        .setPositiveButton(getString(R.string.dialog_button_retry),
                                new DialogSheet.OnPositiveClickListener() {
                                    @Override
                                    public void onClick(View v) {
            ...
            public Map<String, String> getHeaders() {
                ...
                params.put("Authorization", new UserSessionManager(ReadyDispatchListActivity.this).getUserDetails().get("token")/*new UserSessionManager(requireActivity()).getToken()*/);
                return params;
            }
        };
...
//1 day = 3600 x 24 = 86400
    ...
    private void initViews() {
        ...
        mPackingRecycler = findViewById(R.id.readyToDispatchRecycler);
    ...
    public void updateToolbar(int count) {
        mTitleToolbar.setText("Ready Orders(" + count +")");
    }
