...
import ae.tudomart.store.adapters.orders.orderList.AdapterPaginatedSpittedListing;
 ...
 */
public class ReadyToDispatchFragment extends Fragment {

    private RecyclerView readyToDispatchRecycler;
    ...
    public ReadyToDispatchFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_ready_to_dispatch, container, false);
...
//                addData();
    ...
    private void initRecyclerView() {
        ...
        final LinearLayoutManager mLayoutManager = (LinearLayoutManager) readyToDispatchRecycler.getLayoutManager();
        readyToDispatchRecycler.addOnScrollListener(new RecyclerView.OnScrollListener() {
            @Override
            public void onScrolled(RecyclerView recyclerView, int dx, int dy) {
                if (dy > 0) { //check for scroll down
                    visibleItemCount = readyToDispatchRecycler.getLayoutManager().getChildCount();
        ...
        readyToDispatchRecycler.setAdapter(adapter);
    ...
    private void addData() {
        ...
        readyToDispatchRecycler.setVisibility(View.VISIBLE);
...
//        Log.d("REDAY REQ", requestBody.toString());
        //Log.d("REDAY URL", ApiUrl.READY_DISPATCH_URL);
...
//1 day = 3600 x 24 = 86400
    ...
    private void initViews(View view) {
        readyToDispatchRecycler = view.findViewById(R.id.readyToDispatchRecycler);
