 ...
 */
public class DispatchedListFragment extends Fragment {

    private RecyclerView dispatchedRecycler;
    private ArrayList<ModelOrderList> data = new ArrayList<>();
    private RecyclerView mPackingOrdersRecycler;
   ...
   private LinearLayout mErrorParentLayout;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_dispatched_list, container, false);
        initViews(view);
        initSwipeRefresh();
        initRecyclerView();
       // addData();
...
//                addData();
    ...
    private void initRecyclerView() {
        ...
        final LinearLayoutManager mLayoutManager = (LinearLayoutManager) dispatchedRecycler.getLayoutManager();
        dispatchedRecycler.addOnScrollListener(new RecyclerView.OnScrollListener() {
            @Override
            public void onScrolled(RecyclerView recyclerView, int dx, int dy) {
                if (dy > 0) { //check for scroll down
                    visibleItemCount = dispatchedRecycler.getLayoutManager().getChildCount();
        ...
        dispatchedRecycler.setAdapter(adapter);
    ...
    private void addData() {
        ...
        dispatchedRecycler.setVisibility(View.VISIBLE);
        ...
        Log.d("dispatched_or", "addData: "+requestBody);


        JsonObjectRequest clearNotifRequest = new JsonObjectRequest(Request.Method.POST, ApiUrl.DISPATCHED_ORDERS_URL, requestBody, new Response.Listener<JSONObject>() {
            @Override
            public void onResponse(JSONObject response) {
                Log.d("dispatched_or", "addData: "+response);
...
//1 day = 3600 x 24 = 86400
    ...
    private void initViews(View view) {
        ...
        dispatchedRecycler = view.findViewById(R.id.dispatchedRecycler);
