...
import ae.tudomart.store.adapters.orders.orderDetails.AdapterStoreOrderDetails;
...
import ae.tudomart.store.ui.fragments.DashboardFragment;
import ae.tudomart.store.utils.Utils;

public class StoreOrderAccept extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.collect_store_fragment);
        initViews();
...
//                MyDialogSheet dialog = new MyDialogSheet(StoreOrderAccept.this);
...
//        });
    ...
    private void addData() {
        ...
        RequestQueue rQueue = Volley.newRequestQueue(StoreOrderAccept.this);
        JSONObject requestBody = new JSONObject();

        try {
            requestBody.put("strLoginUserId", new UserSessionManager(StoreOrderAccept.this).getUserDetails().get("userid")/*new UserSessionManager(requireActivity()).getUserId()*/);
            requestBody.put("strStoreId", new UserSessionManager(StoreOrderAccept.this).getUserDetails().get("shop")/* new UserSessionManager(requireActivity()).getUserId()*/);
        ...
        JsonObjectRequest clearNotifRequest = new JsonObjectRequest(Request.Method.POST, ApiUrl.ALL_ORDERS_DETAILS_URL, requestBody, new Response.Listener<JSONObject>() {
                ...
                try {
                    if (response.getBoolean("success")) {
                       ...
                       /* final ProgressDialog loginProgress = new ProgressDialog(OrderAcceptActivity.this);
                        ...
                        mOrderItemsRecycler.setAdapter(new AdapterStoreOrderDetails(list, StoreOrderAccept.this, new AdapterStoreOrderDetails.AdapterEvents() {
                            @Override
            ...
            public void onErrorResponse(VolleyError error) {
                ...
                mLoadingLayout.setVisibility(GONE);
                mOrderItemsRecycler.setVisibility(GONE);
                Utils.checkVolleyError(StoreOrderAccept.this, error);
                MyDialogSheet dialogSheet = new MyDialogSheet(StoreOrderAccept.this);
                dialogSheet.setTitle(getString(R.string.dialog_title_error_loading_data))
                        .setMessage(new VolleyErrorHandler(StoreOrderAccept.this).getVolleyError(error))
                        .setPositiveButton(getString(R.string.dialog_button_retry),
                                new DialogSheet.OnPositiveClickListener() {
                                    @Override
                                    public void onClick(View v) {
                        ...
                        .setBackgroundColor(ContextCompat.getColor(StoreOrderAccept.this, R.color.white))
                        .setButtonsColorRes(R.color.colorAccent)
                        .setNegativeButton(getString(R.string.dialog_button_cancel),
                                null);
                dialogSheet.show();
            ...
            public Map<String, String> getHeaders() {
                ...
                params.put("Authorization", new UserSessionManager(StoreOrderAccept.this).getUserDetails().get("token") /*new UserSessionManager(requireActivity()).getToken()*/);
                return params;
            }
        };
    ...
    private void callAcceptOrder() {
        ...
        final ProgressDialog loginProgress = new ProgressDialog(StoreOrderAccept.this);
        loginProgress.setMessage("Please Wait...");
            ...
            public void onResponse(JSONObject response) {
                ...
                try {
                    if (response.getBoolean("success")) {
                        ...
                        final P07FancyAlert alert = new P07FancyAlert(StoreOrderAccept.this);
    ...
    public void onClickCancel(View view) {
        final MyDialogSheet dialog = new MyDialogSheet(StoreOrderAccept.this);
